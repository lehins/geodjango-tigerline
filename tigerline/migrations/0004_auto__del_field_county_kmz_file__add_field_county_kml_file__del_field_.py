...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'County.kml_file'
        db.add_column(u'tigerline_county', 'kml_file',
                      self.gf('smart_fields.models.fields.SmartKMLFileField')(max_length=100, null=True),
                      keep_default=False)

        # Deleting field 'SubCounty.kmz_file'
        db.delete_column(u'tigerline_subcounty', 'kmz_file')

        # Adding field 'SubCounty.kml_file'
        db.add_column(u'tigerline_subcounty', 'kml_file',
                      self.gf('smart_fields.models.fields.SmartKMLFileField')(max_length=100, null=True),
                      keep_default=False)
        ...
        # Adding field 'State.kml_file'
        db.add_column(u'tigerline_state', 'kml_file',
                      self.gf('smart_fields.models.fields.SmartKMLFileField')(max_length=100, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'County.kml_file'
        db.delete_column(u'tigerline_county', 'kml_file')
        ...
        # Deleting field 'SubCounty.kml_file'
        db.delete_column(u'tigerline_subcounty', 'kml_file')
        ...
        # Deleting field 'State.kml_file'
        db.delete_column(u'tigerline_state', 'kml_file')
